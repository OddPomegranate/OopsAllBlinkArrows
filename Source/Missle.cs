...
public class MissleArrow : Arrow
{
    ...
    {
        var missleHud = context.Registry.Subtextures.RegisterTexture(
            "MissleArrowHud", () => OopsAllArrowsModule.ArrowAtlas["MissleArrowHud"]);

        return context.Registry.Arrows.RegisterArrows("Missle", new ArrowConfiguration
        {
            ArrowPickupName = "Missles",
            CreateArrow = () => new MissleArrow(),
            CreateArrowPickupSprite = _ =>
            {
                var pickupSprite = new Sprite<int>(OopsAllArrowsModule.ArrowAtlas["MissleArrowPickup"], 12, 12, 0);
    ...
    {
        normalImage = new Image(OopsAllArrowsModule.ArrowAtlas["MissleArrow"]);
        normalImage.Origin = new Vector2(11f, 3f);
        buriedImage = new Image(OopsAllArrowsModule.ArrowAtlas["MissleArrowBuried"]);
