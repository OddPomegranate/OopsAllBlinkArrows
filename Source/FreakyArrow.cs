...
public class FreakyArrow : Arrow
{
    ...
    {
        var freakyHud = context.Registry.Subtextures.RegisterTexture(
            "FreakyArrowHud", () => OopsAllArrowsModule.ArrowAtlas["FreakyArrowHud"]);

        return context.Registry.Arrows.RegisterArrows("Freaky", new ArrowConfiguration
        {
            ArrowPickupName = "Freaky Arrows",
            CreateArrow = () => new FreakyArrow(),
            CreateArrowPickupSprite = _ =>
            {
                var pickupSprite = new Sprite<int>(OopsAllArrowsModule.ArrowAtlas["FreakyArrowPickup"], 12, 12, 0);
                pickupSprite.Add(0, 0.3f, new int[2] { 0, 1 });
    ...
    {
        normalImage = new Image(OopsAllArrowsModule.ArrowAtlas["FreakyArrow"]);
        normalImage.Origin = new Vector2(13f, 3f);
        buriedImage = new Image(OopsAllArrowsModule.ArrowAtlas["FreakyArrowBuried"]);
